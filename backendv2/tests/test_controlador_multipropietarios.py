...
class TestCalcularTotalEnajenado100:
    ...
    # calculates total enajenado correctly when all rut_enajenantes are present in multipropietario_temp
...
class TestObtenerFechaMasAntigua:
    ...
    def test_fecha_actual_none_fecha_agrupada_not_none(self):
        ...
        assert obtener_fecha_mas_antigua(fecha_actual, fecha_agrupada) == True
