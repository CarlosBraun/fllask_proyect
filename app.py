...
class Formulario(db.Model):
    ...
    enajenantes = db.relationship('Enajenante', backref='formulario', lazy=True)
    adquirentes = db.relationship('Adquirente', backref='formulario', lazy=True)
...
def submit_form():
    ...
    fecha_inscripcion = datetime.strptime(request.form['fecha_inscripcion'], '%Y-%m-%d')
    ...
    for enajenante_data in request.form.getlist('enajenante'):
        ...
        enajenante = Enajenante(runrut=runrut, porc_derecho=porc_derecho, formulario_id=formulario.id)
    ...
    for adquirente_data in request.form.getlist('adquirente'):
        ...
        adquirente = Adquirente(runrut_adq=runrut_adq, porc_derecho_adq=porc_derecho_adq, formulario_id=formulario.id)
